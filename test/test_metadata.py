...
class TestGenerateBasicMetadataStructure(unittest.TestCase):
    ...
    def test_returns_scrape_response(self):
        self.assertIsInstance(self.result, ScrapeResponse)
    ...
    def test_to_dict_preserves_expected_api_shape(self):
...
class TestGenerateBasicMetadataFallback(unittest.TestCase):
    ...
    def test_fallback_to_dict_has_expected_keys(self):
        payload = generate_basic_metadata(None).to_dict()
        self.assertEqual(
            {
                "success",
                "title",
